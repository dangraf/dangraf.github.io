...
One way to remember is that our processes shall be seen as a "baseline" that makes it possible to compare our changes against. This makes it possible to constantly improve. It shall not be seen as a statue that only shall be seen and never touched.
...
- Demo: Show finished tasks:
 ...
 - Present a current state in the project and workload needed to reach the project goal.
 - Present a prioritized list of tasks/questions/problems to be solved for the upcomming sprint. 
